...
BUSINESS_RULES = ROOT / "erpnext" / "construcontrol" / "business_rules.py"
...
class FinanceContractTest(unittest.TestCase):
	...
	def setUpClass(cls) -> None:
		...
		cls.business_rules = BUSINESS_RULES.read_text(encoding="utf-8")
	...
	def test_amounts_and_reconciliation_are_validated_server_side(self) -> None:
		...
		self.assertIn("funding_amounts", self.finance)
		self.assertIn("La comisión no puede superar", self.business_rules)
