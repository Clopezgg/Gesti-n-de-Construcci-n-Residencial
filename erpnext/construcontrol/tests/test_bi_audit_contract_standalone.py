...
class BIAndAuditContractTest(unittest.TestCase):
	...
	def test_report_key_is_deterministic_and_sensitive_to_sources(self) -> None:
		module = load_reporting_utils()
		first = module.deterministic_report_key("financial", "P1", "2026-07-01", "2026-07-19", {"x": 1})
		second = module.deterministic_report_key("financial", "P1", "2026-07-01", "2026-07-19", {"x": 1})
		changed = module.deterministic_report_key("financial", "P1", "2026-07-01", "2026-07-19", {"x": 2})
	...
	def test_dashboard_reuses_canonical_reporting_service(self) -> None:
		...
		self.assertIn("from erpnext.construcontrol.reporting import get_reporting_summary", source)
