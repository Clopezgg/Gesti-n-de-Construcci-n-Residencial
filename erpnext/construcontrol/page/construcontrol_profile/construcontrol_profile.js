frappe.pages["construcontrol-profile"].on_page_load = function (wrapper) {
	...
	const page = frappe.ui.make_app_page({ parent: wrapper, title: "Mi perfil", single_column: true });
    ...
    <div class="cc-profile-page">
      <section class="cc-profile-hero">
        ...
        <div class="cc-profile-heading"><span id="cc-profile-role" class="cc-profile-role-large">USUARIO</span><h2 id="cc-profile-display-name">Cargando perfil...</h2><p id="cc-profile-email" class="text-muted"></p></div>
      </section>
      <div class="cc-profile-layout">
        ...
        <section id="cc-correction-card" class="cc-profile-card cc-profile-wide-card" hidden>
          <div class="cc-profile-card-title"><strong>Autorización de correcciones críticas</strong><span>Acceso exclusivo de Administrator; la clave nunca se muestra ni se guarda en texto visible</span></div>
          <div id="cc-correction-security" class="cc-profile-stats"></div>
          <div class="cc-profile-actions"><button id="cc-configure-correction" class="btn btn-default">Configurar o rotar clave</button><button id="cc-open-corrections" class="btn btn-primary">Abrir centro de correcciones</button></div>
        </section>
        <section class="cc-profile-card cc-profile-wide-card"><div class="cc-profile-card-title"><strong>Proyectos asignados</strong><span>Obras a las que tiene acceso</span></div><div id="cc-projects" class="cc-profile-projects"><span class="text-muted">Cargando...</span></div></section>
        <section class="cc-profile-card cc-profile-wide-card"><div class="cc-profile-card-title"><strong>Actividad reciente</strong><span>Acciones auditadas dentro del sistema</span></div><div id="cc-activity" class="cc-profile-activity"><span class="text-muted">Cargando...</span></div></section>
      </div>
    </div>
  `);
