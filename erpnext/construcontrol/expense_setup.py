...
def _exclude_standard_fields(
	...
	for doctype, fields in definitions.items():
		...
		skipped = [
			str(field.get("fieldname") or "") for field in fields if field.get("fieldname") in standard_fields
		]
		filtered[doctype] = [field for field in fields if field.get("fieldname") not in standard_fields]
		if skipped:
			print(
				f"[ConstruControl] reusing standard fields on {doctype}: " + ", ".join(sorted(skipped)),
				flush=True,
			)
	return filtered
...
def ensure_expense_fields() -> None:
	definitions: dict[str, list[dict[str, Any]]] = {
		"CC Expense Control": [
			{
				...
				"label": "Factura y orden de compra",
			...
			{
				"fieldname": "amount_breakdown_section",
				"label": "Desglose financiero",
				"fieldtype": "Section Break",
				"insert_after": "invoice_attachment",
			},
			{
				...
				"fieldtype": "Currency",
				"options": "HNL",
				"insert_after": "amount_breakdown_section",
			},
			{
				"fieldname": "tax_hnl",
				"label": "Impuestos (L)",
				...
				"options": "HNL",
				"default": "0",
				"insert_after": "subtotal_hnl",
			},
			{
				"fieldname": "withholding_hnl",
				"label": "Retenciones (L)",
				"fieldtype": "Currency",
				"options": "HNL",
				"default": "0",
				"insert_after": "tax_hnl",
			},
			{
				"fieldname": "discount_hnl",
				"label": "Descuentos (L)",
				"fieldtype": "Currency",
				"options": "HNL",
				"default": "0",
				"insert_after": "withholding_hnl",
			},
			{
				"fieldname": "calculated_total_hnl",
				"label": "Total calculado (L)",
				"fieldtype": "Currency",
				"options": "HNL",
				"read_only": 1,
				"insert_after": "discount_hnl",
			},
			{
				"fieldname": "payment_control_section",
				"label": "Pago y cuenta por pagar",
				"fieldtype": "Section Break",
				"insert_after": "calculated_total_hnl",
			},
			{
				...
				"default": "draft",
				"in_list_view": 1,
				"insert_after": "payment_control_section",
			},
			{
				"fieldname": "approved_amount_hnl",
				"label": "Monto aprobado (L)",
				"fieldtype": "Currency",
				"options": "HNL",
				"read_only": 1,
			...
			},
			{
				...
				"default": "0",
				"in_list_view": 1,
				"insert_after": "approved_amount_hnl",
			},
			{
				"fieldname": "balance_due_hnl",
				"label": "Saldo pendiente (L)",
				"fieldtype": "Currency",
				"options": "HNL",
				"read_only": 1,
				"in_list_view": 1,
				"insert_after": "paid_amount_hnl",
			},
			{
				"fieldname": "payment_reference",
				"label": "Referencia de pago",
				"fieldtype": "Data",
				"insert_after": "balance_due_hnl",
			},
			{
			...
			{
				"fieldname": "payment_evidence",
				"label": "Comprobante de pago",
				"fieldtype": "Attach",
				"insert_after": "payment_date",
			},
			{
				"fieldname": "professional_approval_status",
				"label": "Aprobación",
				"fieldtype": "Select",
				"options": "draft\npending\napproved\nrejected",
				"default": "draft",
				"in_list_view": 1,
				"insert_after": "payment_evidence",
			},
			{
				...
				"options": "User",
				"read_only": 1,
				"insert_after": "professional_approval_status",
			},
			{
		...
		"CC Payable Control": [
			...
			{
				"fieldname": "original_amount_hnl",
				"label": "Monto original (L)",
				"fieldtype": "Currency",
				"options": "HNL",
				"insert_after": "due_date",
			},
			{
				...
				"fieldtype": "Currency",
				"options": "HNL",
				"insert_after": "original_amount_hnl",
			},
			{
				"fieldname": "balance_due_hnl",
				"label": "Saldo (L)",
