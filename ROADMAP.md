...
| 1 · Experiencia | **Bloque C — centro de mando** | Ya responde de un vistazo qué hacer hoy (banda de agenda) y sus tarjetas usan el componente compartido `nxr-ds-card`. El responsable definió tres zonas nuevas pendientes: actividad del equipo, atajos de navegación reciente y resumen de cumplimiento/vencimientos |
