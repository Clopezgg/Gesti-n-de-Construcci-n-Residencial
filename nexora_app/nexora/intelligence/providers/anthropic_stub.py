...
@register_adapter
class AnthropicStubAdapter(AIProviderAdapter):
	"""Adaptador simulado para Anthropic (Claude).

	No importa ningún SDK de Anthropic ni ningún cliente HTTP: mismo alcance
