...
**LOTE 1 PUBLICADO EN `main` — FASE 1 EN EJECUCIÓN**

- Rama final: `main`
- Base remota verificada: `3cfeda130b41263a857906040ea8cfdc2b49873b`
- PR #14: fusionado
- SHA funcional publicado: `b65f7c119b5b15620ae312d11cb3eb3447b25b86`
- CI del lote: aprobado
...
| ID                 | Requisito                                                                          | Estado                                           |
| ------------------ | ---------------------------------------------------------------------------------- | ------------------------------------------------ |
| `NXR-F1-DASH-0001` | El dashboard debe cargar con o sin proyecto seleccionado.                          | PUBLICADO EN `main`; VALIDACIÓN VISUAL PENDIENTE |
| `NXR-F1-DASH-0002` | El cambio de proyecto debe recargar el resumen.                                    | PUBLICADO EN `main`; VALIDACIÓN VISUAL PENDIENTE |
| `NXR-F1-DASH-0003` | Deben existir acciones visibles para registrar ingreso y egreso.                   | PUBLICADO EN `main`; VALIDACIÓN VISUAL PENDIENTE |
| `NXR-F1-DASH-0004` | Los tipos y estados técnicos deben presentarse en español.                         | PUBLICADO EN `main`; VALIDACIÓN VISUAL PENDIENTE |
| `NXR-F1-DASH-0005` | Los fallos de carga deben producir una respuesta visible y no un fallo silencioso. | PUBLICADO EN `main`; VALIDACIÓN VISUAL PENDIENTE |
| `NXR-F1-DASH-0006` | El backend y los valores canónicos no deben alterarse por la traducción visual.    | PUBLICADO EN `main`; VALIDACIÓN VISUAL PENDIENTE |
...
Las pruebas del repositorio, los controles de calidad, la instalación limpia, el rollback, MariaDB,
la persistencia real y el commit publicado ya fueron aprobados. La clasificación correcta del lote es
**PUBLICADO EN `main`, PENDIENTE DE VALIDACIÓN VISUAL EN SITIO FRAPPE, IPHONE Y PWA**.
