...
- Artefacto: `NEXORA-ENTREGA-FINAL-1.0.0-<SHA_CORTO>.zip`
...
6. no quedan cambios necesarios fuera de `main`.
...
Este documento no certifica por sí solo la entrega. La certificación corresponde al resultado verde de los workflows del SHA exacto y al artefacto generado por GitHub Actions. Cualquier job rojo rechaza automáticamente la entrega hasta ser corregido.
