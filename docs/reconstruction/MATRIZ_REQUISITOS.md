...
| DB-01 | Eliminar DocFields/Custom Fields duplicados | Orden definitiva | Esquema | Implementado; validación remota pendiente | Colisiones estándar/custom/migración | Reutilizar campos y fallar ante metadata duplicada | Auditoría de 37 DocTypes y runtime sin colisiones | Pendiente de SHA | 114/114 local |
| DB-02 | Hacer instalación y migraciones idempotentes y compatibles | Orden definitiva | Migraciones | Implementado; validación final del bloque pendiente | Runtime descubrió fixtures, estados y riesgo de metadata duplicada | Corregir setup/esquema y agregar regresiones | `bench migrate` repetido, contrato SHA, CRUD y persistencia | `04bf6111`, `4071454c` | Runtime base aprobado; nuevo control pendiente de CI |
...
| INF-01 | Docker, DB, Redis, workers, scheduler, WebSocket y persistencia | Orden definitiva | Evidencia base aprobada; Bloque 12 pendiente | Runtime aislado descubrió dependencias reales | Consolidar servicios y healthchecks | Compose, reinicio, persistencia y backup | `beb4b48c`, `4071454c` | Runtime base aprobado |
...
| REG-01 | Regresión integral no autorreferencial | Orden definitiva | Calidad | En ejecución | Checks históricos podían ser superficiales | Pruebas de comportamiento y artifacts | 111 standalone; runtime, migración, CRUD, persistencia y backup | `33e79a50`, `e96213b6`, `4071454c` | Base integral aprobada; faltan bloques 3-12 |
