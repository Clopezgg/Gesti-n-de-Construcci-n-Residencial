...
| DB-02 | Hacer instalación y migraciones idempotentes y compatibles | Orden definitiva | Migraciones | Evidencia base aprobada; Bloque 3 pendiente | Runtime descubrió fixtures y estado FI02 incompatibles | Corregir setup/esquema y agregar regresiones | `bench migrate` repetido, CRUD y persistencia | `04bf6111`, `4071454c` | Base runtime aprobada; auditoría completa en Bloque 3 |
