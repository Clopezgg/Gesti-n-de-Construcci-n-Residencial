...
| VAL-C-001 | PWA/infraestructura | Pendiente | iPhone, PWA, servicios, reinicio, redeploy, backup y restore | Alta | Evidencia base histórica de contenedor/runtime | Los Bloques 11 y 12 todavía no están cerrados | C | Pendiente |
